...
/**
 * The Client class takes care of everything related to HTTP communication.
 * It also handles errors occuring on both the HTTP and the webdriver level.
 *
 * @class
 */
...
proto.request = function(method, resource, data, callback) {
  var client  = this
    , options = JSON.parse(JSON.stringify(this.defaults))
    , req;
